...
public class Setup implements TestDataProvider {
    ...
    public void tearDown() throws TestDataException {
        ...
        entityManager.remove(this.jobMode);
    ...
    private void addJobModes() {
        EntityManager entityManager = this.getEntityManager();
        entityManager.getTransaction().begin();
        this.jobMode = new JobModeEntity();
        this.jobMode.setName("REPLACE");
        entityManager.persist(this.jobMode);
        entityManager.getTransaction().commit();
    }
    ...
    private void addJobs() {
        ...
        this.job.setJobMode(this.jobMode);
