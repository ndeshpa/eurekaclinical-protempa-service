 ...
 * @author Andrew Post
 */
public class IdPool implements Pool<Long> {
    ...
    @Override
    public Long valueFor(String inValue) throws PoolException {
        return this.idPoolIdDao.getByPoolIdAndFromId(this.id, inValue).getId();
    }
