 ...
 * @author Nita
 */
class AOUParticipantDestinationsDTOExtractor extends DestinationsDTOExtractor<EtlAouParticipantDestination, AOUParticipantDestinationEntity> {

    AOUParticipantDestinationsDTOExtractor(AuthorizedUserEntity user, EtlGroupDao inGroupDao) {
        super(user, inGroupDao);
    }

    @Override
    EtlAouParticipantDestination extractDTO(Perm perm,
            AOUParticipantDestinationEntity destinationEntity) {
        EtlAouParticipantDestination dest = new EtlAouParticipantDestination();
