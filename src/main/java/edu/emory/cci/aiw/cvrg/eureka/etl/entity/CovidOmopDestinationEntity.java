 ...
 */
@Entity
@Table(name = "covid_omop_destinations")
public class CovidOmopDestinationEntity extends DestinationEntity {
    
    private static final Comparator<CovidOmopDestinationTableColumnEntity> TABLE_COLUMN_COMPARATOR = new Comparator<CovidOmopDestinationTableColumnEntity>() {
        @Override
        public int compare(CovidOmopDestinationTableColumnEntity o1, CovidOmopDestinationTableColumnEntity o2) {
    ...
    private List<CovidOmopDestinationTableColumnEntity> tableColumns;
    
    private boolean alwaysQuoted = false;

    public CovidOmopDestinationEntity() {
        this.tableColumns = new ArrayList<>();
    }

    public List<CovidOmopDestinationTableColumnEntity> getTableColumns() {
        return new ArrayList<>(tableColumns);
    }

    public void setTableColumns(List<CovidOmopDestinationTableColumnEntity> inTableColumns) {
        if (inTableColumns == null) {
            this.tableColumns = new ArrayList<>();
        } else {
            this.tableColumns = new ArrayList<>(inTableColumns);
            for (CovidOmopDestinationTableColumnEntity tableColumn : this.tableColumns) {
    ...
    public void addTableColumn(CovidOmopDestinationTableColumnEntity inTableColumn) {
    ...
    public void removeTableColumn(CovidOmopDestinationTableColumnEntity inTableColumn) {
