 ...
 */
@Entity
@Table(name = "omop_dest_tablecolumns")
public class OmopDestinationTableColumnEntity {

    @Id
    @SequenceGenerator(name = "OMOP_DEST_TC_SEQ_GENERATOR",
            sequenceName = "OMOP_DEST_TC_SEQ", allocationSize = 1, initialValue = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE,
            generator = "OMOP_DEST_TC_SEQ_GENERATOR")
    private Long id;
    ...
    private OmopDestinationEntity destination;
    ...
    public void setDestination(OmopDestinationEntity inDestination) {
    ...
    public OmopDestinationEntity getDestination() {
