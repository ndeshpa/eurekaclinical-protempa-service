 ...
 */
@Entity
@Table(name = "phen_dest_dataspecs", uniqueConstraints = {@UniqueConstraint(columnNames = {"name", "phendestinations_id"})})
public class PhenotypeDestinationDataSpecEntity {
	@Id
	@SequenceGenerator(name = "PHEN_DS_SEQ_GENERATOR",
		sequenceName = "PHEN_DS_SEQ", allocationSize = 1, initialValue = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE,
		generator = "PHEN_DS_SEQ_GENERATOR")
	private Long id;
