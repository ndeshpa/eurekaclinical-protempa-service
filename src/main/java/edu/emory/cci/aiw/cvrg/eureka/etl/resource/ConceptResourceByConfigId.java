 ...
 */
@Transactional
@Path("/protected/conceptsbyconfigid")
@RolesAllowed({"researcher"})
@Produces(MediaType.APPLICATION_JSON)
public class ConceptResourceByConfigId {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(ConceptResourceByConfigId.class);
	private final EtlProperties etlProperties;

	@Inject
	public ConceptResourceByConfigId(EtlProperties inEtlProperties) {
