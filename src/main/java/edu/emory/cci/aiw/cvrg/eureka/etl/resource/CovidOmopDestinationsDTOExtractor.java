 ...
 */
class CovidOmopDestinationsDTOExtractor extends DestinationsDTOExtractor<EtlCovidOmopDestination, CovidOmopDestinationEntity> {

    CovidOmopDestinationsDTOExtractor(AuthorizedUserEntity user, EtlGroupDao inGroupDao) {
        super(user, inGroupDao);
    }

    @Override
    EtlCovidOmopDestination extractDTO(Perm perm,
    		CovidOmopDestinationEntity destinationEntity) {
    	EtlCovidOmopDestination dest = new EtlCovidOmopDestination();
        ...
        List<CovidOmopDestinationTableColumnEntity> tableColumnEntities = destinationEntity.getTableColumns();
        for (CovidOmopDestinationTableColumnEntity entity : tableColumnEntities) {
