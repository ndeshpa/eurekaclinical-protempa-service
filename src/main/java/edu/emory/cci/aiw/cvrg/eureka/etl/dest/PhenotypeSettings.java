 ...
 *
 */
class PhenotypeSettings extends AbstractSettings {
	private final PhenotypeSearchDestinationEntity entity;

	PhenotypeSettings(PhenotypeSearchDestinationEntity entity) {
		this.entity = entity;
	}
