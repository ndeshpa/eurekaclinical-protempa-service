 ...
 * @author arpost
 */
public class QueryResultsHandlerWithUnitOfWork implements QueryResultsHandler {
    ...
    @Override
    public String getId() {
        return this.queryResultsHandler.getId();
    }

    @Override
    public String getDisplayName() {
        return this.queryResultsHandler.getDisplayName();
    }

    @Override
    public void validate() throws QueryResultsHandlerValidationFailedException {
        this.queryResultsHandler.validate();
    }
    ...
    @Override
    public void cancel() {
        this.queryResultsHandler.cancel();
    }
